...
public class Productos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnCarpinteria =(Button) vista.findViewById(R.id.btnCarpinteria);
        btnCarpinteria.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent carpinteria = new Intent( getActivity() , ProductoC.class);
                startActivity(carpinteria);


            }
        });

        btnRopa =(Button) vista.findViewById(R.id.btnRopa);
        btnRopa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent ropa = new Intent( getActivity() , ProductoR.class);
                startActivity(ropa);
        ...
        btnVarios =(Button) vista.findViewById(R.id.btnVarios);
        btnVarios.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent varios = new Intent( getActivity() , ProductoV.class);
                startActivity(varios);
