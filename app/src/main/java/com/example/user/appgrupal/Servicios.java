...
public class Servicios extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnLimpieza =(Button) vista.findViewById(R.id.btnLimpieza);
        ...
        btnAcarreo =(Button) vista.findViewById(R.id.btnAcarreo);
        ...
        btnEntretenimiento =(Button) vista.findViewById(R.id.btnEntretenimiento);
