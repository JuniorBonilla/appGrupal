...
public class AlimentoF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long l) {
                ...
                Intent Intento = new Intent(AlimentoF.this,InformacionT.class);
    ...
    private void consultalista() {
        ...
        Cursor cursor= db.rawQuery("select * from Empleado where  Profesion = 'vendedor de frutas y/o verduras'",null);
